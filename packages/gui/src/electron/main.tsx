...
import AppIcon from '../assets/img/one64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import oneEnvironment from '../util/oneEnvironment';
...
// Set the userData directory to its location within ONE_ROOT/gui
setUserDataDir();
...
if (!handleSquirrelEvent()) {
  ...
  const ensureCorrectEnvironment = () => {
    ...
    if (!oneEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
      app.quit();
      return false;
    }
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'One Blockchain Wiki' }),
          click: () => {
            openExternal('https://github.com/xone-network/one-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/xone-network/one-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/xone-network/one-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/xone-network/one-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/xone-network/one-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on KeyBase' }),
          click: () => {
            openExternal('https://keybase.io/team/one_network.public');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/one_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // One Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'One' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About One Blockchain' }),
          click: () => {
            openAbout();
          },
        },
