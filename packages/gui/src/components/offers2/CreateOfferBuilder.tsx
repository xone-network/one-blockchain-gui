...
import { useGetWalletsQuery, useCreateOfferForIdsMutation, usePrefs } from '@xone-network/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@xone-network/core';
...
type CreateDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (XONE), indicates whether a token or CAT has a default entry
...
export function createDefaultValues(params: CreateDefaultValuesParams): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      nfts,
      xone: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
