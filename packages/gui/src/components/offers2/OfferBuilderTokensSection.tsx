...
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@xone-network/core';
import { Tokens } from '@xone-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>One Asset Tokens (CATs) are tokens built on top of XONE</Trans>}
