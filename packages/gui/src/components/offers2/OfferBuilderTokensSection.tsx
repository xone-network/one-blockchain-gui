...
import { Tokens } from '@one/icons';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@one/core';
...
export default function OfferBuilderTokensSection(
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={
        <Trans>One Asset Tokens (CATs) are tokens built on top of XONE</Trans>
      }
