import { defaultPlotter, toBech32m, fromBech32m } from '@xone-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@xone-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@xone-network/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.ONEPOS),
  });
