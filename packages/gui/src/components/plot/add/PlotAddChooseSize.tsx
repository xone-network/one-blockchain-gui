import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@xone-network/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plot Size</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/xone-network/one-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
