...
import { CardStep, Select, StateColor } from '@one/core';
import { useGetPlottersQuery } from '@one/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@one/api';
import type { Plotter, PlotterMap } from '@one/api';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default One Proof of Space plotter. If unsure,
            use the default One Proof of Space plotter.
        </Trans>
      </Typography>
