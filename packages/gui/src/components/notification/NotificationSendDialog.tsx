...
import { useGetCurrentAddressQuery, useGetNFTInfoQuery, useSendNotificationsMutation } from '@xone-network/api-react';
import {
  AlertDialog,
  Amount,
  ButtonLoading,
...
export default function NotificationSendDialog(props: NotificationSendDialogProps) {
  ...
  async function handleSubmit(values: NotificationSendDialogFormData) {
    ...
    const amountMojos = oneToMojo(amount);
