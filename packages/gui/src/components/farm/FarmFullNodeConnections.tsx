import type { Connection } from '@xone-network/api';
import { ServiceName } from '@xone-network/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@xone-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@xone-network/core';
