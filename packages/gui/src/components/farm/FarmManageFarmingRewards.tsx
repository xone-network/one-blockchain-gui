import { fromBech32m } from '@xone-network/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@xone-network/api-react';
import { Button, Flex, Form, TextField, Loading } from '@xone-network/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25XONE reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
