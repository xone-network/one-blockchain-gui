import { Connection } from '@xone-network/api';
import { useGetFullNodeConnectionsQuery } from '@xone-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@xone-network/core';
