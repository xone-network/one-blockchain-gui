import { useOpenFullNodeConnectionMutation } from '@xone-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@xone-network/core';
