import { Button, Flex } from '@xone-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The One application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                One services version: {backV}
                <br />
                One application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the One application and stop all One services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
