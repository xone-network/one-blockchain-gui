import { Flex, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@xone-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              WalletConnect enables a decentralized app on the One blockchain to communicate and make requests directly
              to a One wallet.
            </Trans>
          </SettingsText>
        </Flex>
