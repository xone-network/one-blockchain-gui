import { useDeleteUnconfirmedTransactionsMutation } from '@xone-network/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@xone-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToOneLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
