import type { PlotNFT, PlotNFTExternal } from '@xone-network/api';
import { useGetPoolLoginLinkQuery } from '@xone-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@xone-network/core';
