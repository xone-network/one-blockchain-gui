...
import { Button, CopyToClipboard, Flex, Link, Loading } from '@one/core';
import {
  Alert,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@one/api-react';
import type { PlotNFT, PlotNFTExternal } from '@one/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/One-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
