import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@xone-network/api-react';
import { Flex, State, Loading, StateTypography } from '@xone-network/core';
