import type { UnconfirmedPlotNFT } from '@xone-network/api';
import { useGetTransactionQuery } from '@xone-network/api-react';
import { Flex, Link, Loading } from '@xone-network/core';
