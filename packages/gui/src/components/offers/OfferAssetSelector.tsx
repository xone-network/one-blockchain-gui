...
import { Select, useCurrencyCode } from '@xone-network/core';
...
type BuildAssetSelectorListParams = {
  ...
  oneCurrencyCode: string;
};

function buildAssetSelectorList(params: BuildAssetSelectorListParams): WalletOfferAssetSelection[] {
  const { wallets, catList, rows, otherRows, selectedWalletId, oneCurrencyCode } = params;
