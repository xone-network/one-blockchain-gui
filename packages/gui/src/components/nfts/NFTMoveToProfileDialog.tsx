import { NFTInfo } from '@xone-network/api';
import type { Wallet } from '@xone-network/api';
import { useGetDIDsQuery, useGetNFTWallets, useSetNFTDIDMutation, useLocalStorage } from '@xone-network/api-react';
import {
  AlertDialog,
  Button,
  ButtonLoading,
...
export function NFTMoveToProfileAction(props: NFTMoveToProfileActionProps) {
  ...
  async function handleSubmit(formData: NFTMoveToProfileFormData) {
    ...
    const feeInMojos = oneToMojo(fee || 0);
    let isValid = true;
