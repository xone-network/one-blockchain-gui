...
import { useGetDIDsQuery, useGetNFTWallets, useGetNFTWalletsWithDIDsQuery } from '@xone-network/api-react';
import { DropdownActions, MenuItem } from '@xone-network/core';
import { NFTsSmall as NFTsSmallIcon } from '@xone-network/icons';
