...
import { Button, Flex, Form, TextField, Loading } from '@one/core';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@one/api-react';
import {
  Alert,
  Dialog,
  DialogActions,
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    0.25XONE reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
