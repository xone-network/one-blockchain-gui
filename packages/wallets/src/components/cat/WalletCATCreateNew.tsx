...
import { oneToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@one/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = oneToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New One Asset Token Wallet</Trans>
        </Back>
        <Card>
