import type { CATToken } from '@xone-network/api';
import { SyncingStatus } from '@xone-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@xone-network/api-react';
import { Back, Flex, Loading, useShowError } from '@xone-network/core';
