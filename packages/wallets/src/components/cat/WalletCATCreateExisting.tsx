...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@one/core';
import { Box, Grid } from '@mui/material';
import { useDispatch } from 'react-redux';
import { useForm } from 'react-hook-form';
import { useNavigate } from 'react-router';
import { create_cc_for_colour_action } from '../../../modules/message';
import { oneToMojo } from '@one/core';
...
export default function WalletCATCreateExisting() {
  ...
  async function handleSubmit(values: CreateExistingCATWalletData) {
    try {
      ...
      const feeMojos = oneToMojo(fee || '0');
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid
            ...
            : <Trans>Create One Asset Token Wallet from Existing TAIL</Trans>}
