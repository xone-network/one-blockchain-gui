import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@xone-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@xone-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for XONE, CATs, or
