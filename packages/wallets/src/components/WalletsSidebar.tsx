...
import { useGetLoggedInFingerprintQuery, useGetPrivateKeyQuery, useGetWalletsQuery } from '@xone-network/api-react';
import {
  Flex,
  CardListItem,
  useOpenDialog,
...
export default function WalletsSidebar() {
  ...
  function handleOpenBlogPost() {
    openExternal('https://www.onechain.vip/cat2blog');
  }
    ...
    openDialog(
      <WalletEmptyDialog>
        <ContentStyled>
          ...
          <ActionsStyled>
            <Flex gap={3} flexDirection="column" width="100%">
              <Button
                ...
                size="large"
                onClick={() =>
                  openExternal(`https://cat1.onechain.vip/#publicKey=${privateKey.pk}&fingerprint=${fingerprint}`)
                }
          ...
          <Link target="_blank" href="https://www.onechain.vip/download/">
