import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@xone-network/api-react';
import { Flex, Loading, truncateValue, useColorModeValue } from '@xone-network/core';
import { Reload } from '@xone-network/icons';
