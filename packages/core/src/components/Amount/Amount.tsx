...
import oneToMojo from '../../utils/oneToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isOneCurrency = ['XONE', 'TXONE'].includes(currencyCode);
  const mojo = isOneCurrency ? oneToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isOneCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
